...
def run():
    ...
    """
    result = pyfiglet.figlet_format("YoutubeVedio Downloader", font="slant")
    default_opts = {
    ...
    print(f"[bold #fec601]Hi, Welcome to Dedploit YT Downloader[/bold #fec601]")
    url = None
    try:
